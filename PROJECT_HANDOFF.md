...
อ่าน `PROJECT_BLUEPRINT.md` ก่อน จากนั้นอ่านไฟล์นี้เพื่อเข้าใจภาพใหญ่ของโปรเจกต์

หลังจากนั้นให้อ่าน `AI_WORK_LOG.md` เพื่อดูงานล่าสุดแบบรายครั้ง

หลังแก้โปรเจกต์ ต้องอัปเดต `AI_WORK_LOG.md` ทุกครั้ง และถ้าเปลี่ยนทิศทาง/สถานะสำคัญของระบบ ให้เพิ่มใน `PROJECT_HANDOFF.md` ด้วย
...
ไฟล์นี้ไม่ใช่ work log รายวัน แต่เป็นไฟล์ส่งต่อความคิดและทิศทางของผู้สร้าง
...
ถ้า AI ตัวอื่นจะทำงานต่อ ให้เริ่มจากการอ่าน `PROJECT_BLUEPRINT.md` แล้วอ่านไฟล์นี้ แล้วอ่าน `AI_WORK_LOG.md` แล้วค่อยอ่านโค้ด
...
1. ก่อนทำงาน อ่าน `PROJECT_HANDOFF.md`
2. อ่าน `AI_WORK_LOG.md`
3. ทำงานโดยไม่ลบงานคนอื่น
4. หลังทำงาน อัปเดต `AI_WORK_LOG.md` ทุกครั้ง
5. ถ้ามีการเปลี่ยนทิศทางหรือ architecture ให้อัปเดต `PROJECT_HANDOFF.md` ด้วย
6. ถ้างานถูกยกเลิก ทำผิดทิศ หรือมีความเสี่ยง ต้องบันทึกไว้ใน `AI_WORK_LOG.md`
...
9. อัปเดต `AI_WORK_LOG.md` ทุกครั้ง แม้เป็นงานเล็ก
...
- เพิ่มไฟล์ `AI_WORK_LOG.md` สำหรับบันทึกการทำงานรายครั้ง
- อัปเดต README และ PROJECT_HANDOFF ให้ AI/คนอื่นต้องอ่าน `PROJECT_HANDOFF.md` และ `AI_WORK_LOG.md` ก่อนทำงาน
- กำหนดกติกาว่าหลังทำงานทุกครั้งต้องเพิ่ม log entry ใน `AI_WORK_LOG.md`
