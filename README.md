...
- คิดกรอบราคาเหมาะสมจากแท็บ `Fair Value` แล้วบันทึกผลเป็นโน้ตเข้าคลังความรู้
- วางลิงก์/ข้อความจากคลิป โพสต์ Facebook หรือบทความในแท็บ `Link to Knowledge` เพื่อให้ AI สกัดเป็นความรู้เก็บเข้าคลัง
- ทดลอง payoff/options backtest เบื้องต้นจากแท็บ `Options Lab`

## ส่งต่องานให้ AI/คนอื่น

ก่อนทำงานต่อ ให้อ่าน 2 ไฟล์นี้ก่อนทุกครั้ง:

👉 **[PROJECT_HANDOFF.md](PROJECT_HANDOFF.md)**

👉 **[AI_WORK_LOG.md](AI_WORK_LOG.md)**

หลังแก้โปรเจกต์ ต้องอัปเดต `AI_WORK_LOG.md` ทุกครั้ง และถ้าเป็นการเปลี่ยนทิศทาง/สถานะใหญ่ ให้เพิ่มใน `PROJECT_HANDOFF.md` ด้วย เพื่อให้คนถัดไปทำงานต่อได้ไม่หลงบริบท
